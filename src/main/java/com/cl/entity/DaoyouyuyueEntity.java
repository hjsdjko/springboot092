...
public class DaoyouyuyueEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DaoyouyuyueEntity() {
		
	}
	
	public DaoyouyuyueEntity(T t) {
		try {
	 ...
	 * 设置：导游时长
	 */
	public void setDaoyoushizhang(String daoyoushizhang) {
		this.daoyoushizhang = daoyoushizhang;
	}
	/**
	 * 获取：导游时长
	 */
	public String getDaoyoushizhang() {
		return daoyoushizhang;
	}
	/**
	 * 设置：支付金额
	 */
