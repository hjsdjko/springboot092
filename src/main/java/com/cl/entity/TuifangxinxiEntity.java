...
public class TuifangxinxiEntity<T> implements Serializable {
	...
	public void setTuifangliyou(String tuifangliyou) {
		this.tuifangliyou = tuifangliyou;
	}
	/**
	 * 获取：退房理由
	 */
	 ...
	 * 设置：退房原因
	 */
	public void setTuifangyuanyin(String tuifangyuanyin) {
		this.tuifangyuanyin = tuifangyuanyin;
	}
	/**
	 * 获取：退房原因
	 */
	public String getTuifangyuanyin() {
		return tuifangyuanyin;
	}
	/**
	 * 设置：用户账号
	 */
